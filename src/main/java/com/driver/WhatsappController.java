...
public class WhatsappController {
    ...
    public int createMessage(@RequestParam("message") String content){
    ...
    public String findMessage(@RequestParam("start date") Date start, @RequestParam("end date") Date end, @RequestParam("K") int K) throws Exception{
        //This is a bonus problem and does not contains any marks
